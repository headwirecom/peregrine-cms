...
//    public static StarterReadyRule LAUNCHPAD = new StarterReadyRule(STARTER_HTTP_PORT);
    ...
    public Option[] configuration() {
        ...
        return new Option[]{
            ...
            junitBundles(),
            logback(),
//            mavenBundle().groupId("org.apache.sling").artifactId("org.apache.sling.testing.clients").version("2.0.8")
//            optionalRemoteDebug(),
//            optionalJacoco(),
        };
    }
...
//        testProbeBuilder.setHeader(Constants.IMPORT_PACKAGE, "*,org.apache.sling.testing.clients.osgi.OsgiConsoleClient");
...
// TODO: add the adaption test from
// https://github.com/cmrockwell/peregrine-cms/blob/main/slingjunit.parent/core/src/main/java/com/peregrine/slingjunit/AdaptionJTest.java
    @Test

<template>
  <themeclean-components-block v-bind:model="model">
    <div class="d-flex col-12 col-md-10 align-items-center" v-bind:class="{
      ...
      <div class="" v-bind:class="`text-${model.aligncontent}`" v-bind:style="`flex-basis:${model.textwidth}%;`">
      ...
      <div class="d-flex" v-if="model.showbutton == 'true'" v-bind:class="`justify-content-sm-${model.alignbuttons}`">

<template>
	<themeclean-components-block v-bind:model="model">
		<div class="card-deck justify-content-center">
			...
			<div
				class="col-12 col-md-6 col-lg p-0 pb-md-3"
				v-for="(item, i) in model.cards"
				:key="i"
			>
				<div
					class="
					...
					v-bind:style="`background-color:${
						model.customcardcolor === 'true' ? model.cardcolor : ''
					};`"
					v-bind:class="{

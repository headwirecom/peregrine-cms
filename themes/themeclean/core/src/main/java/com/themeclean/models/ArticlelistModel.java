...
/*
    ...
    "Articlelist": {
      ...
      "properties": {
        "numberedlist": {
          "type": "string",
          "x-source": "inject",
          "x-form-label": "Numbered List",
          "x-form-type": "materialswitch"
        },
        "listitems": {
          "type": "string",
          "x-source": "inject",
          "x-form-label": "List Items",
  ...
  "name": "Articlelist",
  "componentPath": "themeclean/components/articlelist",
  "package": "com.themeclean.models",
...
@Model(
        ...
        resourceType = "themeclean/components/articlelist",
...
//GEN]
public class ArticlelistModel extends AbstractComponent {

    public ArticlelistModel(Resource r) { super(r); }

    //GEN[:INJECT
    	/* {"type":"string","x-source":"inject","x-form-label":"Numbered List","x-form-type":"materialswitch"} */
	@Inject

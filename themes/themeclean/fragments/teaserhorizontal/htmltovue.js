module.exports = {
    convert: function($, f) {
    	...
    	f.addIf($.find('h2').first(), "model.showtitle === 'true' && (model.isprimary.toString() == 'false' || ! model.isprimary)")
        f.addIf($.find('h4').first(), "model.showsubtitle === 'true' && (model.isprimary.toString() == 'false'|| ! model.isprimary)")
        f.addIf($.find('p').first(), "model.showtext === 'true' && (model.isprimary.toString() == 'false' || ! model.isprimary)")
        ...
        f.addIf($.find('h1').first(), "model.showtitle == 'true' && model.isprimary.toString() == 'true'")
        f.addIf($.find('h3').first(), "model.showsubtitle === 'true' && model.isprimary.toString() == 'true'")
        f.addIf($.find('h5').first(), "model.showtext === 'true' && model.isprimary.toString() == 'true'")

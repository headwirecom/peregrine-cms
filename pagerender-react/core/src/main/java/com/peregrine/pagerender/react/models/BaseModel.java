 ...
 */
@Model(adaptables = Resource.class, resourceType = "pagerender/react/components/base", defaultInjectionStrategy = DefaultInjectionStrategy.OPTIONAL, adapters = IComponent.class)

      ...
      <div class="usa-grid usa-graphic_list-row">
        <div class="usa-width-one-half usa-media_block">
          ...
          <div class="usa-media_block-body">
            ...
            <p>Graphic headings can be used a few different ways, depending on what your
              landing page is for. Highlight your values, specific program areas, or
              results.</p>
          </div>
        </div>
        <div class="usa-width-one-half usa-media_block">
          ...
          <div class="usa-media_block-body">
            ...
            <p>Keep body text to about 30. They can be shorter, but try to be somewhat
              balanced across all four. It creates a clean appearance with good spacing.</p>
          </div>
        </div>
      </div>
      <div class="usa-grid usa-graphic_list-row">
        <div class="usa-width-one-half usa-media_block">
          ...
          <div class="usa-media_block-body">
            ...
            <p>For anything you want to highlight here, understand what your users know
              now, and what activity or impression you want from them after they see
              it.</p>
          </div>
        </div>
        <div class="usa-width-one-half usa-media_block">
          ...
          <div class="usa-media_block-body">
            ...
            <p>In addition to your goal, find out your users&#x2019; goals. What do they
              want to know or do that supports your mission? Use these headings to show
              those.</p>
          </div>
        </div>
      </div>

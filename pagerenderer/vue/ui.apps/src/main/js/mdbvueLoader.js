...
const mdbvue = {
  load: function( Vue ){
    ...
    Vue.component( 'card-image', mdbCardImage );
    ...
    Vue.component( 'carousel-control', mdbCarouselControl );
    ...
    Vue.component( 'navbar-toggler', mdbNavbarToggler );

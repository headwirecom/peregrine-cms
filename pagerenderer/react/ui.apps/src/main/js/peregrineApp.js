...
function initPeregrineApp() {
	ReactDOM.render(
		React.createElement(CmpPagerenderReactStructurePage, {
			model: getPerView().page,
		}),
		document.getElementById("peregrine-app")
	);
}
...
function processLoadedContent(data, path, firstTime, fromPopState) {
	...
	if (data.description)
		document.getElementsByTagName("meta").description.content =
			data.description;
	if (data.tags)
		document.getElementsByTagName("meta").keywords.content = data.tags;

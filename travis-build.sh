...
curl -L -o ./docker/files/com.peregrine-cms.sling.launchpad-12-SNAPSHOT-oak_tar_far.far https://github.com/peregrine-cms/peregrine-builder/releases/download/0.0.2/com.peregrine-cms.sling.launchpad-12-SNAPSHOT-oak_tar_far.far
curl -L -o ./docker/files/org.apache.sling.feature.launcher.jar  https://github.com/peregrine-cms/peregrine-builder/releases/download/0.0.2/org.apache.sling.feature.launcher.jar

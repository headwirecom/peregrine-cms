...
@Component(
        ...
        property = {
                Constants.SERVICE_DESCRIPTION + "=create folder servlet",
                Constants.SERVICE_VENDOR + "=headwire.com, Inc",
                ServletResolverConstants.SLING_SERVLET_RESOURCE_TYPES + "=api/admin/createFolder"
        }
)
@SuppressWarnings("serial")
public class CreateFolderServlet extends SlingSafeMethodsServlet {

    private final Logger log = LoggerFactory.getLogger(CreateFolderServlet.class);

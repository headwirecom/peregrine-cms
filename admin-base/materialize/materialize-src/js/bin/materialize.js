				...
				var f,
					...
					m = {
						...
						isWrapped: function (e) {
							return (
								e &&
								(e.jquery || (t.Zepto && t.Zepto.zepto.isZ(e)))
							);
						},
						isSVG: function (e) {
				...
				var S = (b.CSS = {
					...
					Hooks: {
						...
						cleanRootPropertyValue: function (e, t) {
							return (
								...
								S.Values.isCSSNullValue(t) &&
									(t = S.Hooks.templates[e][1]),
								t
							);
						},
					...
					Normalizations: {
							...
							clip: function (e, t, r) {
								switch (e) {
									...
									case "extract":
										var a;
										return (
											S.RegEx.wrappedValueAlreadyExtracted.test(
												r
											)
												? (a = r)
												: ((a = r
						...
						register: function () {
							9 >= d ||
								...
								(S.Lists.transformsBase =
									S.Lists.transformsBase.concat(
										S.Lists.transforms3D
									));
							for (
								var e = 0;
								e < S.Lists.transformsBase.length;
								e++
							) {
								!(function () {
									var t = S.Lists.transformsBase[e];
									S.Normalizations.registered[t] = function (
										e,
										r,
										n
									) {
					...
					Names: {
						...
						SVGAttribute: function (e) {
							...
							return (
								(d ||
									(b.State.isAndroid && !b.State.isChrome)) &&
									(t += "|transform"),
					...
					getPropertyValue: function (e, r, n, o) {
						...
						if (S.Hooks.registered[r]) {
							var u = r,
								c = S.Hooks.getRoot(u);
							n === a &&
								(n = S.getPropertyValue(
									e,
									S.Names.prefixCheck(c)[0]
								)),
								S.Normalizations.registered[c] &&
									(n = S.Normalizations.registered[c](
										"extract",
										e,
										n
									)),
							...
							(p = S.Normalizations.registered[r]("name", e)),
								...
								(l = S.Normalizations.registered[r](
									"extract",
									e,
									g
								));
					...
					setPropertyValue: function (e, r, a, n, o) {
						...
						if ("scroll" === r)
							...
							"transform" ===
								S.Normalizations.registered[r]("name", e)
						)
							...
							if (
								(S.Normalizations.registered[r] &&
									((a = S.Normalizations.registered[r](
										"inject",
										e,
										a
									)),
									(r = S.Normalizations.registered[r](
										"name",
										e
									))),
						...
						return (
							...
							f.each(e, function (e, o) {
								if ((i(o) === a && b.init(o), r === a))
									n === a &&
										(n = b.CSS.getPropertyValue(o, t));
								else {
									var s = b.CSS.setPropertyValue(o, t, r);
									"transform" === s[0] &&
										b.CSS.flushTransformCache(o),
										(n = s);
								}
							}),
							n
				...
				var P = function () {
					...
					function n() {
						function e(e) {
							...
							function h() {
								var e = {
										...
										position: S.getPropertyValue(
											o,
											"position"
										),
										fontSize: S.getPropertyValue(
											o,
											"fontSize"
										),
									},
							...
							if ("scroll" === A) {
								...
								s.container
									? m.isWrapped(s.container) ||
									  m.isNode(s.container)
										? ((s.container =
								...
								for (var H in E) {
									if ("element" !== H) {
										...
										(E[H].startValue = E[H].currentValue =
											E[H].endValue),
											(E[H].endValue = N),
											m.isEmptyObject(v) ||
												(E[H].easing = s.easing),
									...
									if (
										...
										((s.display !== a &&
											...
											s._cacheValues && E && E[z]
												...
												? M === a
													? ((B = S.getPropertyValue(
															o,
															I
													  )),
													  (M = S.getPropertyValue(
															o,
															z,
															B
													  )))
						...
						b.mock !== !1 &&
							...
							s.begin &&
								!m.isFunction(s.begin) &&
								(s.begin = null),
							s.progress &&
								!m.isFunction(s.progress) &&
								(s.progress = null),
							s.complete &&
								!m.isFunction(s.complete) &&
								(s.complete = null),
							s.display !== a &&
								null !== s.display &&
								((s.display = s.display
		...
		this.each(function () {
			...
			function updateOptions() {
				...
				if (origin.data("stoppropagation") !== undefined)
					curr_options.stopPropagation =
						origin.data("stoppropagation");
			}
      ...
      */
			function placeDropdown(eventType) {
				...
				if (offsetTop + activates.innerHeight() > windowHeight) {
					...
					if (
						offsetTop + originHeight - activates.innerHeight() <
						0
					) {
						var adjustedHeight =
							windowHeight - offsetTop - verticalOffset;
...
(function ($, Vel) {
					...
					value: function handleTriggerClick(e) {
						...
						if (e.target && $trigger.length) {
							...
							if (modalId) {
								...
								modalId =
									$trigger[0].getAttribute("data-target");
							}
							var modalInstance =
					...
					value: function animateOut() {
						...
						var exitVelocityOptions = {
							...
							complete: function () {
								...
								if (
									typeof _this2.options.complete ===
									"function"
								) {
									_this2.options.complete.call(
										_this2,
										_this2.$el
									);
								}
								_this2.$overlay[0].parentNode.removeChild(
									_this2.$overlay[0]
								);
							},
						};
	...
	$.fn.modal = function (methodOrOptions) {
		...
		if (Modal.prototype[methodOrOptions]) {
			...
			$.error(
				"Method " + methodOrOptions + " does not exist on jQuery.modal"
			);
		}
	};
...
(function ($) {
	...
	$.fn.tabs = function (methodOrOptions) {
		if (methods[methodOrOptions]) {
			...
			$.error(
				"Method " + methodOrOptions + " does not exist on jQuery.tabs"
			);
		}
	};
				...
				"mouseenter.tooltip": function (e) {
					var showTooltip = function () {
						...
						if (tooltipPosition === "top") {
							// Top Position
							targetTop =
								origin.offset().top - tooltipHeight - margin;
							targetLeft =
								origin.offset().left +
								originWidth / 2 -
								tooltipWidth / 2;
							...
							backdrop.css({
								...
								marginLeft:
									tooltipWidth / 2 - backdropOffsetWidth / 2,
							});
						}
						// Left Position
							...
							targetTop =
								...
								tooltipHeight / 2;
							targetLeft =
								origin.offset().left - tooltipWidth - margin;
							newCoordinates = repositionWithinScreen(
								targetLeft,
								targetTop,
								tooltipWidth,
						...
						// Right Position
							...
							targetTop =
								...
								tooltipHeight / 2;
							targetLeft =
								origin.offset().left + originWidth + margin;
							newCoordinates = repositionWithinScreen(
								targetLeft,
								targetTop,
								tooltipWidth,
						...
						scaleXFactor =
							(Math.SQRT2 * tooltipWidth) /
							parseInt(backdropOffsetWidth);
						scaleYFactor =
							(Math.SQRT2 * tooltipHeight) /
							parseInt(backdropOffsetHeight);
			...
			[
				...
				},
				{
					...
					value: function _removeContainer() {
						...
						Toast._container.parentNode.removeChild(
							Toast._container
						);
	...
	$.scrollSpy = function (selector, options) {
		...
		selector.each(function (i, element) {
			...
			$('a[href="#' + $(element).attr("id") + '"]').click(function (e) {
				e.preventDefault();
				var offset =
					$(Materialize.escapeHash(this.hash)).offset().top + 1;
				$("html, body").animate(
		...
		selector.on("scrollSpy:enter", function () {
			...
			if (visible[0]) {
				...
				if (
					$this.data("scrollSpy:id") < visible[0].data("scrollSpy:id")
				) {
	...
	$(document).ready(function () {
		...
		function textareaAutoResize($textarea) {
			...
			if ($textarea.data("original-height") <= hiddenDiv.height()) {
				...
				$textarea.val().length < $textarea.data("previous-length")
			) {
				/**
					...
					$autocomplete
						...
						.on(
							...
							function () {
								...
								if (
									typeof options.onAutocomplete === "function"
								) {
	...
	$.fn.material_select = function (callback) {
		$(this).each(function () {
			...
			$newSelect.on({
				focus: function () {
					if (
						$("ul.select-dropdown").not(options[0]).is(":visible")
					) {
	...
	$.fn.material_chip = function (options) {
		...
		this.init = function () {
			...
			self.$el.each(function () {
				...
				if (
					!curr_options.data ||
					!(curr_options.data instanceof Array)
				) {
					curr_options.data = [];
				}
		...
		this.handleEvents = function () {
			...
			self.$document
				...
				.on("keydown.chips", function (e) {
					...
					// delete
					var $chip = self.$document.find(
						SELS.CHIP + SELS.SELECTED_CHIP
					);
					var $chips = $chip.closest(SELS.CHIPS);
		...
		this.chips = function ($chips, chipId) {
			...
			if (self.hasAutocomplete) {
				curr_options.autocompleteOptions.onAutocomplete = function (
					val
				) {
	...
	function PickerConstructor(ELEMENT, NAME, COMPONENT, OPTIONS) {
		...
		var IS_DEFAULT_THEME = false,
			...
			STATE = {
				id:
					ELEMENT.id ||
					"P" + Math.abs(~~(Math.random() * new Date())),
			},
			...
			P = (PickerInstance.prototype = {
				...
				close: function (giveFocus) {
					...
					setTimeout(function () {
						...
						P.$root.removeClass(
							CLASSES.opened + " " + CLASSES.focused
						);
				...
				set: function (thing, value, options) {
					...
					options =
						thingIsObject && $.isPlainObject(value)
							? value
							: options || {};
				...
				.on(
					...
					function () {
						...
						if (
							targetDisabled ||
							(activeElement &&
								!$.contains(P.$root[0], activeElement))
						) {
							P.$root.eq(0).focus();
						}
     ...
     */
		group: function (groupObject) {
			var // Scope for the looped object
				...
				counter = PickerConstructor._.trigger(
					groupObject.min,
					groupObject
				);
			...
			for (
				;
				counter <=
				PickerConstructor._.trigger(groupObject.max, groupObject, [
					counter,
				]);
		...
		isInteger: function (value) {
			return (
				{}.toString.call(value).indexOf("Number") > -1 &&
				value % 1 === 0
			);
		},
			...
			.on(
				...
				function () {
					...
					if (calendar.disabled(calendar.get("now"))) {
						includeToday =
							":not(." + settings.klass.buttonToday + ")";
					}
					picker.$root
	...
	DatePicker.prototype.set = function (type, value, options) {
		...
		if (type == "select") {
			...
			if (
				...
				calendar.disabled(calendarItem.highlight)
			) {
	...
	DatePicker.prototype.disabled = function (dateToVerify) {
		var calendar = this,
			...
			isDisabledMatch = calendar.item.disable.filter(function (
				...
				if ($.isArray(dateToDisable) || _.isDate(dateToDisable)) {
					return (
						dateToVerify.pick ===
						calendar.create(dateToDisable).pick
					);
				}
		...
		isDisabledMatch =
			...
			!isDisabledMatch.filter(function (dateToDisable) {
				return (
					($.isArray(dateToDisable) &&
						dateToDisable[3] == "inverted") ||
		...
		return {
			...
			toString: function (formatString, itemObject) {
				...
				return calendar.formats
					...
					.map(function (label) {
						return (
							_.trigger(calendar.formats[label], calendar, [
								0,
								itemObject,
							]) || label.replace(/^!/, "")
						);
			...
			datesToEnable.map(function (unitToEnable) {
				...
				for (index = 0; index < disabledItemsCount; index += 1) {
					...
					// When an overlapped match is found, add the “inverted” state to it.
						...
						calendar.isDateOverlap(disabledUnit, unitToEnable)
					) {
					...
					_.node(
						...
						_.node(
							...
							"type=button data-pick=" +
								nowObject.pick +
								(isOpen && !calendar.disabled(nowObject)
									? ""
									: " disabled") +
								" " +
	...
	ClockPicker.prototype.show = function (e) {
		...
		$doc.on(
			...
			function (e) {
				var target = $(e.target);
				if (
					target.closest(self.popover.find(".picker__wrap"))
						.length === 0 &&
		...
		init: function (options) {
			...
			return this.each(function (i) {
				...
				var showIndicators =
					...
					hasMultipleSlides;
				var noWrap =
					view.attr("data-no-wrap") ||
					options.noWrap ||
					!hasMultipleSlides;
				var uniqueNamespace =
					view.attr("data-namespace") || namespace + i;
				...
				if (options.fullWidth) {
					...
					if (showIndicators) {
						view.find(".carousel-fixed-item").addClass(
							"with-indicators"
						);
					}
				}
				...
				function scroll(x) {
					...
					if (!options.fullWidth) {
						alignment =
							"translateX(" +
							(view[0].clientWidth - item_width) / 2 +
							"px) ";
						alignment +=
							"translateY(" +
							(view[0].clientHeight - item_height) / 2 +
							"px)";
					} else {
					...
					if (showIndicators) {
						...
						var activeIndicator = $indicators.find(
				...
				function autoScroll() {
					...
					if (amplitude) {
						...
						delta =
							amplitude * Math.exp(-elapsed / options.duration);
						if (delta > 2 || delta < -2) {
							scroll(target - delta);
	...
	var methods = {
		init: function (options) {
			return this.each(function () {
				...
				var tapTargetWrapper = tapTargetEl.parent(
					".tap-target-wrapper"
				);
				var tapTargetWave = tapTargetWrapper.find(".tap-target-wave");
				var tapTargetOriginEl =
					tapTargetWrapper.find(".tap-target-origin");
				var tapTargetContentEl = tapTargetEl.find(
					".tap-target-content"
				);

									...
									extractValue: function (t, e) {
										...
										if (i) {
											var n = i[0],
												o = i[1];
											return (e =
												k.Hooks.cleanRootPropertyValue(
													n,
													e
												))
												.toString()
								...
								Normalizations: {
									...
									register: function () {
										9 >= h ||
											...
											(k.Lists.transformsBase =
												k.Lists.transformsBase.concat(
...
(Vel = jQuery ? jQuery.Velocity : $ ? $.Velocity : Velocity),
								...
								value: function () {
									(this.handleOverlayClickBound =
										...
										(this.handleModalCloseClickBound =
											this.handleModalCloseClick.bind(
												this
											)),
										1 === n._count &&
							...
							},
							{
								...
								value: function (e) {
									...
									if (e.target && i.length) {
										...
										var o =
											document.getElementById(n).M_Modal;
		...
		(n._increment = 0),
			...
			(t.fn.modal = function (e) {
				return n.prototype[e]
					...
					: "object" != typeof e && e
					? void t.error(
							"Method " + e + " does not exist on jQuery.modal"
					  )
	...
	(function (t) {
		t(document).ready(function () {
			...
			var r = function (t) {
					var e =
						-7 + parseInt(t.parent().css("padding-left")) + "px";
					t.velocity(
						{
							height: "30px",
							width: "30px",
				...
				t(this).each(function () {
					...
					if (!n.hasClass("browser-default")) {
						...
						var g = function (e, i, n) {
								if (i) {
									e.find("li.selected").removeClass(
										"selected"
									);
									var a = t(i);
									a.addClass("selected"),
		...
		return (
			...
			(e._ = {
				...
				isInteger: function (t) {
					return (
						{}.toString.call(t).indexOf("Number") > -1 && t % 1 == 0
					);
				},
	...
	(function (t) {
		...
		(i.prototype.set = function (t, e, i) {
			...
			return null === e
				...
				: ((o["enable" == t ? "disable" : "flip" == t ? "enable" : t] =
						n.queue[t]
							.split(" ")
							.map(function (o) {
								return (e = n[o](t, e, i));

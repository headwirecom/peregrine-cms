...
var template = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"editor-panel blue-grey lighten-5"},[_c('span',{staticClass:"panel-title"},[_vm._v("Editor")]),_c('form',[(this.$root.$data.state.editor)?_c('vue-form-generator',{attrs:{"schema":this.$root.$data.state.editor.dialog,"model":_vm.getModel(this.$root.$data.state.editor.path),"options":_vm.formOptions}}):_vm._e(),(this.$root.$data.state.editor.dialog)?_c('button',{staticClass:"btn",on:{"click":function($event){$event.stopPropagation();$event.preventDefault();_vm.onOk($event);}}},[_vm._v("ok")]):_vm._e()],1)])},staticRenderFns: [],
    props: ['model'],
    methods: {

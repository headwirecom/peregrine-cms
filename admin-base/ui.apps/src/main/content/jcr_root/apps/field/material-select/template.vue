		...
		computed: {
			placeholder() {
				if (
					...
					this.schema.selectOptions.placeholder
				) {
			...
			trackBy() {
				if (
					this.schema.selectOptions &&
					this.schema.selectOptions.value
				) {
			...
			label() {
				if (
					this.schema.selectOptions &&
					this.schema.selectOptions.name
				) {
			...
			deselectLabel() {
				if (
					this.schema.selectOptions &&
					this.schema.selectOptions.deselectLabel
				) {
				...
				get() {
					...
					if (this.value && this.value != null) {
						...
						if (typeof this.value === "string") {
							return this.schema.values.filter(

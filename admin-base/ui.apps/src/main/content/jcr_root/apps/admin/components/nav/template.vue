    ...
    computed: {
      ...
      tenantDdItems() {
        return [
          ...
          {label: 'Change Tenant', icon: 'swap_horiz', click: this.onChangeTenantClick}
        ]
      },
      userDdItems() {
        return [

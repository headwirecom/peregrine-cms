...
var compileLESS = (function () {var _ref = _asyncToGenerator(_regeneratorRuntime.mark(function _callee(style, options) {var _ref2, css, map;return _regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.next = 2;return (
                            less.render(style.code, _extends({
                                sourceMap: {
                                    sourceMapFullFilename: style.id,
                                    sourceMapFileInline: false } },

                            options.less)));case 2:_ref2 = _context.sent;css = _ref2.css;map = _ref2.map;
                        ...
                        style);case 7:case 'end':return _context.stop();}}}, _callee, this);}));return function (_x, _x2) {return _ref.apply(this, arguments);};})();
...
var compilePug = (function () {var _ref = _asyncToGenerator(_regeneratorRuntime.mark(function _callee(template, extras, options) {var compiler;return _regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                        compiler = pug.compile(template, _extends({ filename: extras.id }, options.pug));return _context.abrupt('return',

                        compiler({ css: extras.modules || {} }));case 2:case 'end':return _context.stop();}}}, _callee, this);}));return function (_x, _x2, _x3) {return _ref.apply(this, arguments);};})();

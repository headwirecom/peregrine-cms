...
public class GraphQLSchemaServlet extends SlingSafeMethodsServlet {
    ...
    void getChildResources(Resource resource, String fileName, List<Resource> result) {
    ...
    InputStream getSchemaContent(Resource resource) {
    ...
    String convertToSDLSchema(JsonNode root, String name) {
        String answer = "";
        String enums = "";
        String type = root.get("type").asText();
        if("object".equals(type)) {
            name = adjustIdentifier(name);
            answer += "type " + name + " {\n  _path: ID\n";
                ...
                while(keys.hasNext()) {
                    ...
                    if(item != null && item.isObject()) {
                        ...
                        if("string".equals(itemType)) {
                            ...
                            //TODO: Need to handle formats (date, time and date-time)
                        } else
    ...
    private String adjustIdentifier(String identifier) {
